...
namespace DBapplication
{
    public class DBManager
    {
        ...
        static string DB_Connection_String = @"Data Source=MUSTAFA\SQLEXPRESS;Initial Catalog=final;Integrated Security=True";
        ...
        public int ExecuteNonQuery(string query)
        {
            ...
            {
                return -1;  //means that there is an error from database
            }
        }
        ...
        public DataTable ExecuteReader(string query)
        {
            ...
            catch (Exception ex)
            {
                ...
                return null;   //means that there is an error from database
            }
        }
